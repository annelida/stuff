...
* competition							      :drill:
  ...
  :DRILL_LAST_REVIEWED: [2017-09-16 Sat 09:05]
  :END:
...
* venture						      :Lewis Carroll:
  ...
  said the Lory.
* pretext						      :Lewis Carroll:
  noun
   1. предлог (pretext, excuse, preposition, guise, plea, cloak)
   2. отговорка (excuse, pretense, subterfuge, pretext, evasion, alibi)
